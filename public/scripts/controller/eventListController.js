angular.module('myApp')
    .controller('eventListCtrl', ['SweetAlert', '$rootScope', '$scope', '$state', '$filter', '$http', 'ngDialog', 'NgTableParams', 'SERVER_BASE_URL', 'UtilityService',
        function (SweetAlert, $rootScope, $scope, $state, $filter, $http, ngDialog, NgTableParams, SERVER_BASE_URL, UtilityService) {
